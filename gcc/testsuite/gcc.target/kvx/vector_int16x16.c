...
{
    return __builtin_kvx_abdhx(a, b-(int16x16_t){0}, "");
}
int16x16_t __attribute ((noinline))
kvx_int16x16_abd0_(int16x16_t a)
{
    return __builtin_kvx_abdhx(a, (int16x16_t){0}, "");
}
int16x16_t __attribute ((noinline))
...
{
    return __builtin_kvx_addhx(a, b-(int16x16_t){0}, "");
}
int16x16_t __attribute ((noinline))
...
{
    return __builtin_kvx_sbfhx(a, b-(int16x16_t){0}, "");
}
int16x16_t __attribute ((noinline))
...
{
    return __builtin_kvx_shlhxs(a, b, "");
}
int16x16_t __attribute ((noinline))
kvx_int16x16_shl3_(int16x16_t a)
{
    return __builtin_kvx_shlhxs(a, 3, "");
}
int16x16_t __attribute ((noinline))
...
{
    return __builtin_kvx_shrhxs(a, 5, "");
}
int16x16_t __attribute ((noinline))
...
int16x16_t __attribute ((noinline))
kvx_int16x16_shrs_as(int16x16_t a, int16_t b)
{
    return __builtin_kvx_shrhxs(a, b, ".as");
}
int16x16_t __attribute ((noinline))
kvx_int16x16_shr7_as(int16x16_t a)
{
...
int16x16_t __attribute ((noinline))
kvx_int16x16_cat256(int16x8_t a, int16x8_t b) {
    return __builtin_kvx_cat256(a, b);
}
int16x16_t __attribute ((noinline))
kvx_int16x16_scat256(int16x8_t a, int16x8_t b) {
    return __builtin_kvx_cat256(b, a);
}
int16x8_t __attribute ((noinline))
kvx_int16x16_low128(int16x16_t a) {
    return __builtin_kvx_low128(a);
}
int16x8_t __attribute ((noinline))
kvx_int16x16_high128(int16x16_t a) {
