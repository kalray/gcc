...
{
    return __builtin_kvx_fadddcp(a, b, ".c.rn");
}
float64x4_t __attribute__ ((noinline))
kvx_float64x4_fsbfcdcp(float64x4_t a, float64x4_t b)
{
    return __builtin_kvx_fsbfdcp(a, b, ".c.rn");
}
float64x4_t __attribute__ ((noinline))
...
float64x4_t __attribute ((noinline))
kvx_float64x4_cat256(float64x2_t a, float64x2_t b) {
    return __builtin_kvx_cat256(a, b);
}
float64x4_t __attribute ((noinline))
kvx_float64x4_scat256(float64x2_t a, float64x2_t b) {
    return __builtin_kvx_cat256(b, a);
}
float64x2_t __attribute ((noinline))
kvx_float64x4_low128(float64x4_t a) {
    return __builtin_kvx_low128(a);
}
float64x2_t __attribute ((noinline))
kvx_float64x4_high128(float64x4_t a) {
