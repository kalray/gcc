...
/* KV3-2 */
/* { dg-final { scan-tree-dump-times "Native: "  9 "cplxlower1"   { target { any-opts "-march=kv3-2" } } } } */
/* { dg-final { scan-tree-dump-times "Split: "  12 "cplxlower1"   { target { any-opts "-march=kv3-2" } } } } */
...
/* KV4-1 */
/* { dg-final { scan-tree-dump-times "Native: "  9 "cplxlower1"   { target { any-opts "-march=kv4-1" } } } } */
/* { dg-final { scan-tree-dump-times "Split: "  12 "cplxlower1"   { target { any-opts "-march=kv4-1" } } } } */
