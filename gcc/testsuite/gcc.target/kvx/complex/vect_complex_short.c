...
/* KV3-1 */
/* { dg-final { scan-tree-dump-times "vectorized 1 loops in function"  7 "vect"         { target { any-opts "-march=kv3-1" } } } } */
...
/* { dg-final { scan-assembler-times "lq"			      10                { target { any-opts "-march=kv3-1" } } } } */
/* { dg-final { scan-assembler-times "sq"                              7                { target { any-opts "-march=kv3-1" } } } } */
