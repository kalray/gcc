...
#define DBX_REGISTER_NUMBER(REGNO) ((((REGNO) >= K1C_GRF_FIRST_REGNO) && ((REGNO) <= K1C_GRF_LAST_REGNO) )? (REGNO) + 512 : (REGNO) - 64)
 ...
 */
#define CASE_VECTOR_MODE ((CASE_VECTOR_PC_RELATIVE || flag_pic)? SImode : Pmode)
