...
#define CPP_SPEC "-D__bare__ %{mhypervisor: -D__mos__ } " "%{pthread: %eThe -pthread option is not supported in bare mode.}" CPP_SPEC_COMMON
...
#define K1_OS_SELF_SPECS						\
  ...
  "%{!mcore*:%{mcluster=io*:" K1_SELECT_IO_CORE ";:%{mboard=iocomm_*:" K1_SELECT_IO_CORE ";:" K1_SELECT_DP_CORE "}}} ", \
   ...
   "%{fPIC:-fno-jump-tables} ",     \
  "%{!mcluster*:%{mcore=k1bdp:-mcluster=node;mcore=k1bio:-mcluster=ioddr;:-mcluster=node}} ",
