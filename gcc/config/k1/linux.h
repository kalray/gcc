...
#define CPP_SPEC CPP_SPEC_COMMON \
  "%{pthread:-D_REENTRANT} "
...
#define K1_OS_SELF_SPECS \
    ...
    "%{mcore=k1dp|mcore=k1bdp|mcore=k1io:%eCompiler can only be used with mcore=k1bio}",	\
    "%{!mcore*:" K1_SELECT_IO_CORE "} ",	\
    "%{!mcluster*:-mcluster=ioddr} ",  \
