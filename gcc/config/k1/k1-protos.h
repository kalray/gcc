...
extern void k1_init_cumulative_args (CUMULATIVE_ARGS *cum, const_tree fntype, rtx libname,
...
extern bool k1_lowbit_highbit_constant_p (HOST_WIDE_INT val, int *lowbit, int *highbit);
...
extern void k1_expand_old_sync_instruction (enum rtx_code code, rtx dest, rtx addr, rtx val);

extern void k1_expand_new_sync_instruction (enum rtx_code code, rtx dest, rtx addr, rtx val);
...
extern bool k1_float_fits_bits(const REAL_VALUE_TYPE *r, unsigned bitsz, enum machine_mode mode);
