...
k1_target_init_builtins (void)
{
  ...
  tree const_intQI_node = build_qualified_type (intQI_type_node, TYPE_QUAL_CONST);
  tree const_intHI_node = build_qualified_type (intHI_type_node, TYPE_QUAL_CONST);
  tree const_intSI_node = build_qualified_type (intSI_type_node, TYPE_QUAL_CONST);
  tree const_intDI_node = build_qualified_type (intDI_type_node, TYPE_QUAL_CONST);
  tree const_float_node = build_qualified_type (float_type_node, TYPE_QUAL_CONST);
  ...
  tree const_string_type_node = build_pointer_type (build_qualified_type (char_type_node, TYPE_QUAL_CONST));
...
#define ADD_K1_BUILTIN(UC_NAME, LC_NAME, ...)                           \
  ...
  /* FIXME AUTO: disabling vector support */
    ...
    ADD_K1_BUILTIN (FFMAWD,  "ffmawd",      floatDF, floatDF, floatSF, floatSF, constSTR);
    ADD_K1_BUILTIN (FFMAWC,  "ffmawc",      floatSC, floatSC, floatSC, floatSC, constSTR);
    ADD_K1_BUILTIN (FFMADC,  "ffmadc",      floatDC, floatDC, floatDC, floatDC, constSTR);
    ...
    ADD_K1_BUILTIN (FFMSWD,  "ffmswd",      floatDF, floatDF, floatSF, floatSF, constSTR);
    ADD_K1_BUILTIN (FFMSWC,  "ffmswc",      floatSC, floatSC, floatSC, floatSC, constSTR);
    ADD_K1_BUILTIN (FFMSDC,  "ffmsdc",      floatDC, floatDC, floatDC, floatDC, constSTR);
