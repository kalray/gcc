...
k1_expand_builtin_get (rtx target, tree args)
{
    ...
    if (regno > K1C_SRF_LAST_REGNO){
      error ("__builtin_k1_get called with illegal SRF register index : %d", INTVAL(arg1));
    }
...
k1_expand_builtin_set (rtx target ATTRIBUTE_UNUSED, tree args, bool ps)
{
    ...
    if (regno > K1C_SRF_LAST_REGNO){
      error ("__builtin_k1_set called with illegal SRF register index : %d", INTVAL(arg1));
    }
...
static rtx
k1_expand_builtin_ffmanw (rtx target, tree args, int rn)
{
    rtx arg1 = expand_normal (CALL_EXPR_ARG (args, 0));
    rtx arg2 = expand_normal (CALL_EXPR_ARG (args, 1));
    rtx arg3 = expand_normal (CALL_EXPR_ARG (args, 2));
    ...
    if (rn)
      emit_insn (gen_ffmanwrn (target, arg2, arg3, arg1));
    else
...
static rtx
k1_expand_builtin_ffmsnw (rtx target, tree args, int rn)
{
    rtx arg1 = expand_normal (CALL_EXPR_ARG (args, 0));
    rtx arg2 = expand_normal (CALL_EXPR_ARG (args, 1));
    rtx arg3 = expand_normal (CALL_EXPR_ARG (args, 2));
    ...
    if (rn)
      emit_insn (gen_ffmsnwrn (target, arg2, arg3, arg1));
    else
                          ...
                          int ignore ATTRIBUTE_UNUSED)
{
    ...
    case K1_BUILTIN_FFMANW:
    case K1_BUILTIN_FFMANWRN:
        return k1_expand_builtin_ffmanw (target, exp, fcode == K1_BUILTIN_FFMANWRN);
    ...
    case K1_BUILTIN_FFMSNW:
    case K1_BUILTIN_FFMSNWRN:
        return k1_expand_builtin_ffmsnw (target, exp, fcode == K1_BUILTIN_FFMSNWRN);
