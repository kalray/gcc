...
(define_insn_reservation "kv3_load_ext" 3 (and (eq_attr "type" "load_ext") (match_test "KV3")) "kv3_lsu_r")
(define_insn_reservation "kv3_load_ext_x" 3 (and (eq_attr "type" "load_ext_x") (match_test "KV3")) "kv3_lsu_x_r")
(define_insn_reservation "kv3_load_ext_y" 3 (and (eq_attr "type" "load_ext_y") (match_test "KV3")) "kv3_lsu_y_r")
;; kv3_load_ext_single
...
(define_insn_reservation "kv4_load_ext" 3 (and (eq_attr "type" "load_ext") (match_test "KV4 && TARGET_DUAL_LSU")) "kv4_lsu_r")
(define_insn_reservation "kv4_load_ext_x" 3 (and (eq_attr "type" "load_ext_x") (match_test "KV4 && TARGET_DUAL_LSU")) "kv4_lsu_x_r")
(define_insn_reservation "kv4_load_ext_y" 3 (and (eq_attr "type" "load_ext_y") (match_test "KV4 && TARGET_DUAL_LSU")) "kv4_lsu_y_r")
(define_insn_reservation "kv4_load_ext_single" 3 (and (eq_attr "type" "load_ext") (match_test "KV4 && !TARGET_DUAL_LSU")) "kv4_lsu_single_r")
(define_insn_reservation "kv4_load_ext_x_single" 3 (and (eq_attr "type" "load_ext_x") (match_test "KV4 && !TARGET_DUAL_LSU")) "kv4_lsu_x_single_r")
(define_insn_reservation "kv4_load_ext_y_single" 3 (and (eq_attr "type" "load_ext_y") (match_test "KV4 && !TARGET_DUAL_LSU")) "kv4_lsu_y_single_r")
