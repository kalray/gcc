        ...
        if (direct_result_case) {
            ...
            if (__builtin_expect(tmp24, 0)) {
                ...
                if (__builtin_expect(tmp27, 0)) {
                    ...
                    tmp38 = __builtin_k1_ffmsrnd(1.0, scaled_vy, slow_init_approx);
                    iter_00 = __builtin_k1_ffmarnd(slow_init_approx, tmp38, slow_init_approx);
                    ...
                    final_approx0 = __builtin_k1_ffmarnd(iter_20, tmp41, iter_20);
                    tmp42 = __builtin_k1_fmulrnd(scaled_vx, final_approx0);
                    yerr00 = __builtin_k1_ffmsrnd(scaled_vx, tmp42, scaled_vy);
                    new_div00 = __builtin_k1_ffmarnd(tmp42, yerr00, final_approx0);
                    yerr_last0 = __builtin_k1_ffmsrnd(scaled_vx, new_div00, scaled_vy);
                    unscaled_div_result = __builtin_k1_ffmad(new_div00, yerr_last0, final_approx0);
                    tmp43 = ex - ey;
                    tmp44 = tmp43 < 950;
                    ...
                    if (tmp57) {
                        ...
                        ext_pre_result = ml_fma_dd_d3(yerr_last0, final_approx0, new_div00);
                        tmp58 = ex - ey;
                        subnormal_pre_result = k1_subnormalize_d_dd_i(ext_pre_result, tmp58);
                        tmp59 = ex - ey;
                        tmp60 = tmp59 < 950;
                ...
                if (__builtin_expect(b5_x_inf_or_nan, 0)) {
                    ...
                    if (__builtin_expect(b3_y_inf_or_nan, 0)) {
                        ...
                        if (div_overflow_case) {
                            ...
                            signed_inf = k1_round_signed_overflow_fp64(fast_init_approx);
                            return signed_inf;
                        } else {
