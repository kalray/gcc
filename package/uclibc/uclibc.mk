...
# kvx definitions
#
ifeq ($(UCLIBC_TARGET_ARCH),kvx)
define UCLIBC_KVX_TYPE_CONFIG
	$(SED) '/CONFIG_KVX_COOLIDGE_*/d' $(@D)/.config
	$(call KCONFIG_ENABLE_OPT,CONFIG_KVX_COOLIDGE_$(call qstrip,$(BR2_KVX_COOLIDGE_VERSION)))
endef
endif
