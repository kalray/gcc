...
else ifeq ($(BR2_KERNEL_HEADERS_KVX),y)
LINUX_HEADERS_VERSION = 6b6e8a4d2dfd4c48f108963578712d4caef4513d
LINUX_HEADERS_CUSTOM_TARBALL = y
LINUX_HEADERS_CUSTOM_TARBALL_LOCATION = $(call github,kalray,linux_coolidge,$(LINUX_HEADERS_VERSION))/linux-$(LINUX_HEADERS_VERSION).tar.gz
